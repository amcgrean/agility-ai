import { Moon, Sun, Share2, FileDown, BarChart3 } from 'lucide-react';
...
export default function TopBar({ darkMode, onToggleTheme, onExportPdf, onShare, onOpenAdmin, currentUser }) {
  return (
